        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              A passionate full-stack developer who treats coding like the
              ultimate game and loves turning wild ideas into reality!
            </p>
          </motion.div>
              ...
              <div className="grid md:grid-cols-3 gap-8 items-center">
                ...
                <div className="md:col-span-2">
                  <div className="text-gray-300 space-y-4">
                    <p>
                      Hey there! I&apos;m a passionate coder who treats coding
                      like the ultimate video game - solving puzzles, breaking
                      things (intentionally... mostly 😅), and building dreams
                      into reality!
                    </p>
                    <p>
                      I&apos;m all about full-stack development and design, with
                      a knack for rapid learning and turning ideas into reality.
                      I&apos;m absolutely amazed by AI (ChatGPT and I are
                      basically best friends), and I love designing things that
                      make people go &quot;Wow!&quot;
                    </p>
                    <p>
                      Technology is my playground, and I thrive in dynamic
                      environments where I can embrace new challenges.
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Link href="/education">
                ...
                >
                  ...
                  <p className="text-gray-300 mb-4">
                    Discover my educational journey from Monash
                    University&apos;s Computer Science program to Imperial
                    College London&apos;s world-renowned engineering program.
                  </p>
              ...
              <Link href="/experience">
                ...
                >
                  ...
                  <p className="text-gray-300 mb-4">
                    Explore my work experience at leading tech companies
                    including Ant International, iFAST Corporation, and my
                    tutoring journey at Monash University.
                  </p>
            ...
            <div className="glass rounded-2xl p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="space-y-2 text-gray-300">
                    <li>
                      • Coding & Software Development (my ultimate passion!)
                    </li>
                    <li>• UI/UX Design & User Experience</li>
                    <li>
                      • Gaming (Teamfight Tactics - reached Rank 300 in Europe!)
                    </li>
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-xl border border-blue-500/20">
                <p className="text-center text-gray-300 italic">
                  &quot;Technology is my playground, and I thrive in dynamic
                  environments where I can embrace new challenges and turn wild
                  ideas into reality!&quot;
                </p>
              </div>
            </div>
