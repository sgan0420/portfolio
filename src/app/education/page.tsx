        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              From academic excellence to world-class institutions - my
              educational path that shaped my passion for technology
            </p>
          </motion.div>
                ...
                <div className="border-l-4 border-green-500 pl-6 pb-8">
                  <div className="relative">
                    ...
                    <p className="text-green-400 mb-4 text-lg">
                      Monash University Malaysia • Oct 2022 - Jul 2025
                    </p>
                    <div className="text-gray-300 space-y-4">
                      <div className="bg-green-500/10 p-4 rounded-xl border border-green-500/30">
                        <p className="text-xl font-bold text-green-300 text-center">
                          🏆 CGPA: 3.97/4.0 | WAM: 90.154/100 | Monash High
                          Achiever Award
                        </p>
                      </div>

                      <p className="text-lg leading-relaxed">
                        Maintained exceptional academic excellence with
                        outstanding performance in computer science
                        fundamentals, including perfect scores and competition
                        victories that showcase both theoretical knowledge and
                        practical skills. Currently pursuing my final year with
                        continued dedication to academic and practical
                        excellence.
                      </p>

                      <div className="grid md:grid-cols-2 gap-6 my-6">
                        <div>
                          <p className="text-green-300 font-semibold mb-3 text-lg">
                            Core Achievements:
                          </p>
                          <ul className="space-y-2">
                            <li>
                              • Outstanding CGPA of 3.97/4.0 & WAM of 90.154/100
                            </li>
                            <li>
                              • Monash High Achiever Award (RM30,000
                              scholarship)
                            </li>
                            <li>
                              • Highest scores achieved in multiple core
                              subjects
                            </li>
                            <li>
                              • 🏆 1st place in AI Pacman Challenge competition
                            </li>
                      ...
                      <div className="bg-gray-800/50 p-4 rounded-xl">
                        ...
                        <ul className="text-sm space-y-1">
                          <li>
                            • AI Pacman Challenge: Developed advanced AI
                            algorithms that secured 1st place victory
                          </li>
                          <li>
                            • Mobile Application Project: Created comprehensive
                            Android app with perfect execution
                          </li>
                          <li>
                            • Python Development: Showcased advanced programming
                            skills with flawless implementation
                          </li>
                          <li>
                            • Database Systems: Designed and implemented complex
                            database solutions
                          </li>
                        </ul>
                      </div>
                      ...
                      <p className="text-sm text-gray-400 bg-gray-800/50 p-3 rounded-lg">
                        <strong>Comprehensive Tech Stack:</strong> Java, Python,
                        JavaScript, TypeScript, HTML5, CSS3, Android Studio,
                        React, Node.js, Git, GitHub, GitLab, Oracle Database,
                        MySQL, R Programming, Haskell, Linux/Unix Systems, MARIE
                ...
                <div className="border-l-4 border-emerald-500 pl-6 pb-8">
                  <div className="relative">
                    ...
                    <p className="text-emerald-400 mb-4 text-lg">
                      Imperial College London • Oct 2019 - Jul 2022
                    </p>
                    <div className="text-gray-300 space-y-4">
                      ...
                      <p className="text-lg leading-relaxed">
                        Excelled in mechanical engineering with recognition for
                        outstanding technical skills and academic performance at
                        one of the world's leading engineering institutions.
                        This foundational engineering experience provided
                        invaluable problem-solving skills and analytical
                        thinking that seamlessly transitioned into computer
                        science.
                      </p>
                      ...
                      <div className="grid md:grid-cols-2 gap-6 my-6">
                        <div>
                          ...
                          <ul className="space-y-2">
                            ...
                            <li>
                              • Advanced mathematical problem-solving skills
                            </li>
                            <li>
                              • International perspective and cultural
                              adaptability
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="bg-gray-800/50 p-4 rounded-xl">
                        <p className="text-emerald-300 font-medium mb-2">
                          Engineering Foundation Impact:
                        </p>
                        <ul className="text-sm space-y-1">
                          <li>
                            • Developed systematic problem-solving approach that
                            translates perfectly to software development
                          </li>
                          <li>
                            • Gained strong mathematical foundation essential
                            for computer science algorithms
                          </li>
                          <li>
                            • Learned precision and attention to detail crucial
                            in programming and system design
                          </li>
                          <li>
                            • Acquired project management and time management
                            skills through complex engineering projects
                          </li>
                        </ul>
                      </div>

                      <p className="text-sm text-gray-400 bg-gray-800/50 p-3 rounded-lg">
                        <strong>Engineering Focus Areas:</strong> Design &
                        Manufacture, Stress Analysis, Fluid Mechanics,
                        Thermodynamics, Mechatronics, Python Programming,
                        SOLIDWORKS, Finite Element Analysis, Mathematical
                ...
                <div className="border-l-4 border-teal-500 pl-6 pb-8">
                  <div className="relative">
                    ...
                    <p className="text-teal-400 mb-4 text-lg">
                      Taylor's College • Jan 2018 - Jul 2019
                    </p>
                    <div className="text-gray-300 space-y-4">
                      <div className="bg-teal-500/10 p-4 rounded-xl border border-teal-500/30">
                        <p className="text-xl font-bold text-teal-300 text-center">
                          🌟 Grade: 4A* | A-Level High Achiever | Taylor's Merit
                          Scholarship
                        </p>
                      </div>

                      <p className="text-lg leading-relaxed">
                        Achieved exceptional results in Cambridge A-Levels with
                        perfect A* grades, earning recognition as a high
                        achiever and merit scholarship recipient. This rigorous
                        academic preparation laid the foundation for success in
                        higher education.
                      </p>

                      <div className="grid md:grid-cols-2 gap-6 my-6">
                        <div>
                          <p className="text-teal-300 font-semibold mb-3 text-lg">
                            Subject Excellence:
                          </p>
                          <ul className="space-y-2">
                            <li>
                              • Mathematics - A* (Advanced pure & applied math)
                            </li>
                            <li>
                              • Physics - A* (Mechanics, electricity, quantum)
                            </li>
                            <li>
                              • Chemistry - A* (Organic, inorganic, physical)
                            </li>
                            <li>
                              • Further Mathematics - A* (Advanced mathematical
                              concepts)
                            </li>
                          </ul>
                        </div>
                        <div>
                          ...
                          <ul className="space-y-2">
                            ...
                            <li>
                              • Perfect preparation for university entrance
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div className="bg-gray-800/50 p-4 rounded-xl">
                        ...
                        <ul className="text-sm space-y-1">
                          <li>
                            • Advanced mathematical reasoning and
                    ...
                    <div className="text-gray-300 space-y-4">
                      <div className="bg-cyan-500/10 p-4 rounded-xl border border-cyan-500/30">
                        <p className="text-xl font-bold text-cyan-300 text-center">
                          🎯 Grade: 7A+ 2A 1A- | Outstanding Academic
                          Performance
                        </p>
                      </div>
                      ...
                      <p className="text-lg leading-relaxed">
                        ...
                        leadership capabilities during secondary education,
                        achieving outstanding results while actively
                        contributing to school community through various
                        leadership roles.
                      </p>
                      ...
                      <div className="grid md:grid-cols-2 gap-6 my-6">
                        ...
                        <div>
                          ...
                          <ul className="space-y-2">
                            ...
                            <li>
                              • Active participant in school cultural events
                            </li>
                            <li>
                              • Developed public speaking and presentation
                              skills
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="bg-gray-800/50 p-4 rounded-xl">
                        ...
                        <ul className="text-sm space-y-1">
                          <li>
                            • Developed strong organizational and team
                            management skills through society leadership
                          </li>
                          <li>
                            • Enhanced strategic thinking and planning abilities
                            through chess club involvement
                          </li>
                          <li>
                            • Gained confident public speaking and crowd
                            engagement experience as school emcee
                          </li>
                          <li>
                            • Built multicultural communication skills and
                      ...
                      <p className="text-sm text-gray-400 bg-gray-800/50 p-3 rounded-lg">
                        <strong>Foundation Skills:</strong> Academic Excellence,
                        Leadership Development, Public Speaking, Strategic
                        Thinking, Cultural Appreciation, Team Management, Event
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Link href="/about">
                ...
                >
                  ...
                  <p className="text-gray-300 text-sm mb-3">
                    Learn more about my story, interests, and what drives my
              ...
              <Link href="/experience">
                ...
                >
                  ...
                  <p className="text-gray-300 text-sm mb-3">
                    Explore my professional journey through leading tech
