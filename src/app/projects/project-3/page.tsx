...
const ProjectDetail = () => {
  ...
  const project = {
    title: "[Project Title 3 - Replace with actual title]",
    description: "Description for your third project. Replace this with details about what this project does, the problems it solves, and the innovative features it provides.",
    longDescription: `
      This is where you can provide a more detailed explanation of your third project. 
    ...
    technologies: [
      ...
      { name: "Database", icon: FaDatabase, color: "text-blue-400" },
    ],
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-12">
            <div className="glass rounded-2xl p-8 text-center">
              <div className="w-full h-64 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg flex items-center justify-center mb-4">
                <p className="text-gray-400">
                  [Add project screenshots, ML model visualizations, or demo video here]
                </p>
              </div>
              <p className="text-gray-400 text-sm">
                Replace this with actual screenshots, model performance charts, or project demonstrations
              </p>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="text-center">
            <div className="glass rounded-2xl p-8">
              <h2 className="text-2xl font-bold mb-4">Excited about AI/ML solutions?</h2>
              <p className="text-gray-300 mb-6">
                This project demonstrates my expertise in machine learning and data science. 
                Let's explore how AI can transform your business challenges into opportunities!
              </p>
              <Link href="/contact">
                <motion.button
                  whileHover={{ scale: 1.05 }}
