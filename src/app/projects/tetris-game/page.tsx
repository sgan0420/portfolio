    ...
    longDescription: (
      <div>
        <p className="mb-4">
          ...
          rendering, and user inputs in real time. The game uses SVG elements to
          draw the grid, pieces, and overlays, giving it a clean, responsive UI
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside space-y-1 ml-4">
            <li>
              <strong>Reactive Architecture with RxJS:</strong> Uses Observables
              to handle real-time game ticks, inputs, and rendering
            </li>
            <li>
              <strong>Functional State Management:</strong> Every input
              (keyboard or click) updates the game state immutably
            </li>
            <li>
              <strong>SVG Rendering:</strong> Tetrominoes and the game grid are
              rendered dynamically with SVG and DOM manipulation
            </li>
          </ul>
        </div>
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside space-y-1 ml-4">
            <li>
              Observable streams for game tick management and input handling
            </li>
            <li>
              Immutable state updates using functional programming principles
            </li>
        ...
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4 mt-4">
          <p className="text-blue-300">
            <strong>Reactive Programming:</strong> This project demonstrates
            advanced reactive programming concepts using RxJS Observables for
                ...
                {!project.githubUrl && !project.liveUrl && (
                  <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                    <p className="text-gray-400 text-sm">
                      🎮 <strong>Game Project</strong> - Repository and playable
                ...
                {[
                  {
                    icon: FaCube,
                    title: "Hold Queue",
                    desc: "Strategic piece management",
                  },
                  {
                    icon: FaPlay,
                    title: "Next Preview",
                    desc: "Plan your moves ahead",
                  },
                  {
                    icon: FaGamepad,
                    title: "Hard Drop",
                    desc: "Quick piece placement",
                  },
                  {
                    icon: FaCode,
                    title: "Wallkick",
                    desc: "Enhanced rotation system",
                  },
                  {
                    icon: SiReactivex,
                    title: "Reactive Scoring",
                    desc: "Real-time score updates",
                  },
                  {
                    icon: SiTypescript,
                    title: "Level Scaling",
                    desc: "Dynamic difficulty progression",
                  },
                ].map((feature, index) => {
          ...
          <motion.div variants={itemVariants} className="text-center">
            <div className="glass rounded-2xl p-8">
              ...
              <p className="text-gray-300 mb-6">
                This project showcases advanced reactive programming patterns
                using RxJS and TypeScript. Let's discuss how reactive
                architecture can enhance your next web application!
              </p>
              <Link href="/contact">
                <motion.button
                  whileHover={{ scale: 1.05 }}
